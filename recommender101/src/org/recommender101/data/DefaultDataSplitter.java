...
public class DefaultDataSplitter extends DataSplitter {
	 ...
	 */
	@R101Setting(type=SettingsType.TEXT,
			defaultValue="-1/-1", displayName="Min Ratings Contraint",
			description="Accepts the min-ratings-per-user / min-ratings-per-item constraint")
