...
//		System.out.println("set item avg recommendations.." + this.useItemAverageForRecommendation);
	...
	/**
	 * Set this to false if it should be a truly unpersonalized method
	 * @param s
	 */
	@R101Setting (displayName="Hide known items", 
			type=SettingsType.BOOLEAN, defaultValue="true", 
			description="Set this to false if it should be a truely unpersonalized method")
